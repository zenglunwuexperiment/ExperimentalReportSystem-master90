...
public class ExperimentSubmitController {
    ...
    @ResponseBody
    public ServerResponse submitExp(HttpSession session,
                                    @RequestParam(value = "choice[]") String[] choice,
                                    @RequestParam(value = "blank[]") String[] blank,
                                    @RequestParam(value = "table1[]") String[] table1,
                                    @RequestParam(value = "table2[]") String[] table2,
                                    @RequestParam(value = "table3[]") String[] table3,
                                    @RequestParam(value = "table4[]") String[] table4){
        ...
        rank = new PhotoeletricExperiment(choice,blank,table1, table2, table3, table4).getScore();
    ...
    public ServerResponse submitExp(HttpSession session,
        ...
        //=============================模板标记==============================
        rank = (new SolarEnergyExperiment(choice, table1, table2, table3, table4, blank)).getScore();
    ...
    public ServerResponse submitExp(HttpSession session,
        ...
        rank = (new GratingdiffractionExperiment(choice,blank,table)).getScore();
    ...
    public ServerResponse submitExp(HttpSession session,
        ...
        rank = (new YoungmodulusExperiment(choice[0], choice[1], choice[2], choice[3], choice[4],
                ...
                choice[10], choice[11], choice[12], choice[13], choice[14], choice[15], choice[16],
                Double.parseDouble(answer[0]), Double.parseDouble(table2[14]) - Double.parseDouble(table2[15]),
                Double.parseDouble(table2[8]) - Double.parseDouble(table2[6]), Double.parseDouble(blank[2]), Sci2con.sci2con(blank[6]))).getScore();
    ...
    public ServerResponse submitExp(HttpSession session,
                                    ...
                                    @RequestParam(value = "table6[]", required = false) String[] table6) {
        ...
        rank = (new InertiaExperiment(choice[0], choice[1], choice[2], choice[3], choice[4], choice[5], choice[6], choice[7], choice[8], choice[9], choice[10],
                Double.parseDouble(blank[7]), Double.parseDouble(table6[18]), Double.parseDouble(table5[18]), Double.parseDouble(table4[18]), Double.parseDouble(table3[18]))).getScore();
    ...
    public ServerResponse submitExp(HttpSession session,
        ...
        rank = (new CollisionShootingExperiment(choice[0], choice[1], choice[2], choice[3], choice[4], choice[5], choice[6], choice[7], choice[8], choice[9],
                Double.parseDouble(blank[1]), Double.parseDouble(table2[0]), Double.parseDouble(table2[1]), Double.parseDouble(table2[2]), Double.parseDouble(table2[3]),
                Double.parseDouble(table2[4]), Double.parseDouble(table2[5]), Double.parseDouble(table2[6]), Double.parseDouble(table2[7]), Double.parseDouble(table2[8]),
                Double.parseDouble(table2[9]), Double.parseDouble(table2[10]), Double.parseDouble(table2[11]), Double.parseDouble(table1[2]), Double.parseDouble(table1[5]))).getScore();
    ...
    @ResponseBody
    public ServerResponse submitExp_7(HttpSession session,
                                      @RequestParam(value = "choice[]", required = false) String[] choice,
                                      @RequestParam(value = "blank[]", required = false) String[] blank,
        ...
        rank = (new NewtonRingExperiment(choice[0], choice[1], choice[2], choice[3], choice[4], choice[5], choice[6], choice[7], choice[8], choice[9], choice[10], choice[11],
                choice[12], choice[13], choice[14], choice[15], choice[16], choice[17], Double.parseDouble(blank[1]), Double.parseDouble(blank[2]))).getScore();
     ...
     * @return
     */
    @RequestMapping(value = "Exp_8.do", method = RequestMethod.POST)
    @ResponseBody
    public ServerResponse submitExp_8(HttpSession session,
                                      @RequestParam(value = "choice[]", required = false) String[] choice,
                                      @RequestParam(value = "blank[]", required = false) String[] blank,
                                      @RequestParam(value = "table1[]", required = false) String[] table1,
                                      @RequestParam(value = "table2[]", required = false) String[] table2,
        ...
        String path;
        Map<String, Object> params = new HashMap<String, Object>();
        ServerResponse serverResponse = iScoreService.isStuHaveScore(8, user.getId());
        if (serverResponse.getStatus() == 15) {
            //报告重复提交
            return serverResponse;
        }
        ...
        params.put("pic1", new PictureRenderData(625, 326, basePath + chartPath + user.getStuNum() + "/8-1.png"));
        params.put("pic2", new PictureRenderData(625, 326, basePath + chartPath + user.getStuNum() + "/8-2.png"));
        //=============================模板标记==============================

        path = basePath + wordPath + "光偏振实验" + "/" + major_name + stu_class + "/";
        File filedir = new File(path);
        if (!filedir.exists()) {
            filedir.setWritable(true);
            filedir.mkdirs();
    ...
    @ResponseBody
    public ServerResponse submitExp_9(HttpSession session,
                                      @RequestParam(value = "choice[]") String[] choice,
                                      @RequestParam(value = "table[]") String[] table,
                                      @RequestParam(value = "blank[]") String[] blank) {
    ...
    public ServerResponse submitExp_10(HttpSession session,
                                       @RequestParam(value = "choice[]") String[] choice,
                                       @RequestParam(value = "table1[]") String[] table1,
                                       @RequestParam(value = "table2[]") String[] table2,
                                       @RequestParam(value = "table3[]") String[] table3,
                                       @RequestParam(value = "table4[]") String[] table4,
                                       @RequestParam(value = "table5[]") String[] table5,
                                       @RequestParam(value = "table6[]") String[] table6,
                                       @RequestParam(value = "table7[]") String[] table7,
                                       @RequestParam(value = "table8[]") String[] table8,
                                       @RequestParam(value = "blank[]") String[] blank) {
        User user = (User) session.getAttribute(Const.CURRENT_USER);
        if (user == null) {
            return ServerResponse.createByErrorCodeMessage(Const.ResponseCode.NEED_LOGIN.getCode(), Const.ResponseCode.NEED_LOGIN.getDesc());
        ...
        for (int i = 0; i < 6; i++) {
            params.put("table5_" + (i + 1) + "", table5[i]);
        }

        for (int i = 0; i < 6; i++) {
            params.put("table6_" + (i + 1) + "", table6[i]);
        }

        for (int i = 0; i < 2; i++) {
            params.put("table7_" + (i + 1) + "", table7[i]);
        }

        for (int i = 0; i < 10; i++) {
            params.put("table8_" + (i + 1) + "", table8[i]);
        }
        ...
        rank = new ReDaoXiShuCeDing(choice, blank, table1, table2, table3, table4, table5, table6, table7, table8).getScore();
    ...
    @ResponseBody
    public ServerResponse submitExp_11(HttpSession session,
                                       @RequestParam(value = "choice[]", required = false) String[] choice,
                                       @RequestParam(value = "blank[]", required = false) String[] blank,
                                       @RequestParam(value = "table[]", required = false) String[] table,
                                       @RequestParam(value = "table_out[]", required = false) String[] table_out) {
