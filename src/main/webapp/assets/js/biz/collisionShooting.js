function autoGenera1(){
    ...
    var y = $("#table_2").val();
    var th = (x * x) / (4 * y);
    var avgX = $("#table_4").val();
    var ah = x * (x - avgX) / (2 * y);
    $("#table_3").val(th.toFixed(2));
    $("#table_5").val(ah.toFixed(2));
}

function autoGenera2(){
    var th = parseFloat($("#table_3").val());
    var rh = parseFloat($("#table_6").val());
    var m = parseFloat($("#table_1").val());
...
//             labels: [12, 13, 14, 15, 16,f 17, 18, 19, 20, 21, 22],
//             datasets: [{
//                 label: "拟合直线",
