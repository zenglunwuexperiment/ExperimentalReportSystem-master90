...
function generateChart1() {
    ...
    var uMax1 = Math.max(table1_u1, table1_u2, table1_u3, table1_u4, table1_u5, table1_u6, table1_u7, table1_u8, table1_u9, table1_u10,
        table1_u11, table1_u12, table1_u13, table1_u14, table1_u15, table1_u16, table1_u17, table1_u18, table1_u19, table1_u20, table1_u21);
    $("#blank_2").val(uMax1 .toFixed(4));
    ...
    var pMax1 = Math.max(table1_y1, table1_y2, table1_y3, table1_y4, table1_y5, table1_y6, table1_y7, table1_y8, table1_y9, table1_y10,
        table1_y11, table1_y12, table1_y13, table1_y14, table1_y15, table1_y16, table1_y17, table1_y18, table1_y19, table1_y20, table1_y21);
    $("#blank_1").val(pMax1 .toFixed(4));
    ...
    chart1 = new Chart(ctx, { type: 'line',
        data: {
            labels: [table1_x1, table1_x2, table1_x3, table1_x4, table1_x5, table1_x6, table1_x7, table1_x8, table1_x9, table1_x10,
                table1_x11, table1_x12, table1_x13, table1_x14, table1_x15, table1_x16, table1_x17, table1_x18, table1_x19, table1_x20, table1_x21],
            datasets: [{ label: "P=U^2/R",
                backgroundColor: 'rgb(255, 99, 132)',
                borderColor: 'rgb(255, 99, 132)',
                data: [table1_y1, table1_y2, table1_y3, table1_y4, table1_y5, table1_y6, table1_y7, table1_y8, table1_y9, table1_y10, table1_y11,
                    table1_y12, table1_y13, table1_y14, table1_y15, table1_y16, table1_y17, table1_y18, table1_y19, table1_y20,table1_y21],
                fill: false }] },
        options: { responsive: true,
            title: { display: true, text: 'P-R曲线图'},
            tooltips: { mode: 'index', intersect: false },
            hover:    { mode: 'nearest', intersect: true},
            scales: { xAxes: [{ display: true, scaleLabel: { display: true, labelString: 'R'}}],
                      yAxes: [{ display: true, scaleLabel: { display: true, labelString: 'P'}}] } }
    });
}
...
function generateChart2() {
    ...
    var table2_y28=iur(table2_r28, table2_x28);

    var iMax1 = Math.max(table2_y1, table2_y2, table2_y3, table2_y4, table2_y5, table2_y6, table2_y7, table2_y8, table2_y9, table2_y10, table2_y11, table2_y12, table2_y13,
        table2_y14, table2_y15, table2_y16, table2_y17, table2_y18, table2_y19, table2_y20, table2_y21, table2_y22, table2_y23, table2_y24, table2_y25, table2_y26, table2_y27,
        table2_y28);
    $("#blank_3").val(iMax1 .toFixed(4));
    ...
    $("#table2_56").val(table2_y28);

    var p1 = parseFloat($("#blank_1").val());
    var u1 = parseFloat($("#blank_2").val());
    var i1 = parseFloat($("#blank_3").val());
    var FF1 = p1 /( u1 * i1);
    $("#blank_4").val(FF1 .toFixed(2));

    var ctx = document.getElementById('chart2').getContext('2d');
    chart2 = new Chart(ctx, { type: 'line',
        data: {
            labels: [table2_x1, table2_x2, table2_x3, table2_x4, table2_x5, table2_x6, table2_x7, table2_x8, table2_x9, table2_x10, table2_x11,
                     table2_x12, table2_x13, table2_x14, table2_x15, table2_x16, table2_x17, table2_x18, table2_x19, table2_x20, table2_x21,
                     table2_x22, table2_x23, table2_x24, table2_x25, table2_x26, table2_x27, table2_x28],
            datasets: [{ label: "I=U/R",
                backgroundColor: 'rgb(255, 99, 132)',
                borderColor: 'rgb(255, 99, 132)',
                data: [table2_y1, table2_y2, table2_y3, table2_y4, table2_y5, table2_y6, table2_y7, table2_y8, table2_y9, table2_y10, table2_y11, table2_y12, table2_y13, table2_y14,
                    table2_y15, table2_y16, table2_y17, table2_y18, table2_y19, table2_y20, table2_y21, table2_y22, table2_y23, table2_y24, table2_y25, table2_y26, table2_y27,
                    table2_y28],
                fill: false }] },
        options:{ responsive: true, title: { display: true, text: 'I-U曲线图' },
            tooltips: { mode: 'index', intersect: false },
            hover: { mode: 'nearest', intersect: true   },
            scales: { xAxes: [{ display: true,scaleLabel: { display: true, labelString: 'U'} }],
                      yAxes: [{ display: true,scaleLabel: { display: true, labelString: 'I'} }] } }
    });
}
...
function generateChart3() {
    ...
    var uMax2 = Math.max(table3_u1, table3_u2, table3_u3, table3_u4, table3_u5, table3_u6, table3_u7, table3_u8, table3_u9, table3_u10, table3_u11,
        table3_u12, table3_u13, table3_u14, table3_u15, table3_u16, table3_u17, table3_u18, table3_u19, table3_u20, table3_u21);
    $("#blank_6").val(uMax2 .toFixed(4));
    ...
    var pMax2 = Math.max(table3_y1, table3_y2, table3_y3, table3_y4, table3_y5, table3_y6, table3_y7, table3_y8, table3_y9, table3_y10, table3_y11,
                        table3_y12, table3_y13, table3_y14, table3_y15, table3_y16, table3_y17, table3_y18, table3_y19, table3_y20, table3_y21);
    $("#blank_5").val(pMax2 .toFixed(4));
    ...
    chart3 = new Chart(ctx, { type: 'line',
        data: { labels: [ table1_x1, table1_x2, table1_x3, table1_x4, table1_x5, table1_x6, table1_x7, table1_x8, table1_x9, table1_x10,
                table1_x11, table1_x12, table1_x13, table1_x14, table1_x15, table1_x16, table1_x17, table1_x18, table1_x19, table1_x20, table1_x21],
            datasets: [{ label: "P=U^2/R",
                backgroundColor: 'rgb(255, 99, 132)',
                borderColor: 'rgb(255, 99, 132)',
                data: [table3_y1, table3_y2, table3_y3, table3_y4, table3_y5, table3_y6, table3_y7, table3_y8, table3_y9, table3_y10, table3_y11,
                    table3_y12, table3_y13, table3_y14, table3_y15, table3_y16, table3_y17, table3_y18, table3_y19, table3_y20,table3_y21],
                fill: false }] },
        options: { responsive: true, title: {display: true, text: 'P-R曲线图' },
            tooltips: { mode: 'index', intersect: false },
            hover: {  mode: 'nearest', intersect: true  },
            scales: { xAxes: [{ display: true, scaleLabel: { display: true, labelString: 'R' } }],
                      yAxes: [{ display: true, scaleLabel: { display: true, labelString: 'P' } }] } }
...
function generateChart4() {
    ...
    var table4_y28=iur(table4_r28, table2_x28);

    var iMax2 = Math.max(table4_y1, table4_y2, table4_y3, table4_y4, table4_y5, table4_y6, table4_y7, table4_y8, table4_y9, table4_y10, table4_y11, table4_y12, table4_y13, table4_y14,
        table4_y15, table4_y16, table4_y17, table4_y18, table4_y19, table4_y20, table4_y21, table4_y22, table4_y23, table4_y24, table4_y25, table4_y26, table4_y27, table4_y28);
    $("#blank_7").val(iMax2 .toFixed(4));
    ...
    $("#table4_56").val(table4_y28);

    var p2 = parseFloat($("#blank_5").val());
    var u2 = parseFloat($("#blank_6").val());
    var i2 = parseFloat($("#blank_7").val());
    var FF2 = p2 /( u2 * i2);
    $("#blank_8").val(FF2 .toFixed(2));

    var ctx = document.getElementById('chart4').getContext('2d');
    chart4 = new Chart(ctx, { type: 'line',
        data: { labels: [ table2_x1, table2_x2, table2_x3, table2_x4, table2_x5, table2_x6, table2_x7, table2_x8, table2_x9, table2_x10, table2_x11,
                          table2_x12, table2_x13, table2_x14, table2_x15, table2_x16, table2_x17, table2_x18, table2_x19, table2_x20, table2_x21,
                          table2_x22, table2_x23, table2_x24, table2_x25, table2_x26, table2_x27,table2_x28],
            datasets: [{ label: "I=U/R",
                backgroundColor: 'rgb(255, 99, 132)',
                borderColor: 'rgb(255, 99, 132)',
                data: [table4_y1, table4_y2, table4_y3, table4_y4, table4_y5, table4_y6, table4_y7, table4_y8, table4_y9, table4_y10, table4_y11, table4_y12, table4_y13, table4_y14,
                    table4_y15, table4_y16, table4_y17, table4_y18, table4_y19, table4_y20, table4_y21, table4_y22, table4_y23, table4_y24, table4_y25, table4_y26, table4_y27, table4_y28],
                fill: false }] },
        options: { responsive: true, title: { display: true, text: 'I-U曲线图'},
            tooltips: { mode: 'index', intersect: false },
...
function submit() {
    ...
    // blank[0] = $("#table1_p").val();
    // blank[1] = $("#table2_i").val();
    // blank[2] = $("#table1_u").val();
    // blank[3] = $("#table2_ff").val();
    // blank[4] = $("#table3_p").val();
    // blank[5] = $("#table4_i").val();
    // blank[6] = $("#table3_u").val();
    // blank[7] = $("#table4_ff").val();
